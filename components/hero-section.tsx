...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-yellow-50 pt-16 overflow-hidden"
    >
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mb-6 sm:mb-8 animate-fadeInLeft delay-200">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3 mt-4">
                <span className="px-3 py-1 bg-[#FFEA00]/20 text-[#083D77] rounded-full text-sm font-semibold">
                  ⚡ 1 kèm 1 Online
                </span>
